...
protocol AboutMeViewControllerDelegate {
    func finishedAboutMe()
}

class AboutMeViewController: UIViewController, UICollisionBehaviorDelegate {
    ...
    @IBOutlet weak var aboutMeProfile: UIImageView!
    
    var delegate: AboutMeViewControllerDelegate?
    ...
    override func viewDidLoad() {
        ...
        aboutMeTextView.addSubview(aboutMeProfile)
        
        var exclusionFrame = aboutMeProfile.frame
        exclusionFrame.origin.y -= 71

        aboutMeTextView.scrollRangeToVisible(NSMakeRange(0, 0))
        aboutMeTextView.textContainer.exclusionPaths = [UIBezierPath(rect: exclusionFrame)]
