//
//  EagerToLearnViewController.swift
//  Anant Jain
//
...
class EagerToLearnViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        UIView.animate(withDuration: 0.25, delay: 1.0, options: .curveEaseOut, animations: { () -> Void in
            ...
            self.titleLabel.alpha = 1.0
                ...
                UIView.animate(withDuration: 0.25, delay: 4.0, options: .curveEaseOut, animations: { () -> Void in
                    self.descriptionLabel.transform = CGAffineTransform.identity
                    self.descriptionLabel.alpha = 1.0
                    }, completion: { (completed) -> Void in
                        
                        self.tapRecognizer = UITapGestureRecognizer(target: self, action: #selector(EagerToLearnViewController.nextSlide(_:)))
